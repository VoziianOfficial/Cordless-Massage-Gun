(function(){
  ...
  qa('.mini-speed button').forEach(b=>b.addEventListener('click',()=>{qa('.mini-speed button').forEach(x=>x.classList.toggle('is-active',x===b));qa('[data-page-add]').forEach(x=>x.dataset.variant=b.textContent.trim())}));
})();
